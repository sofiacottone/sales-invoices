...
--
-- Host: 127.0.0.1    Database: sales_invoices
-- ------------------------------------------------------
...
CREATE TABLE `invoice_details` (
  ...
  PRIMARY KEY (`id`),
  UNIQUE KEY `invoice_id` (`invoice_id`,`description`),
  CONSTRAINT `invoice_details_ibfk_1` FOREIGN KEY (`invoice_id`) REFERENCES `invoices` (`id`) ON DELETE CASCADE
...
-- Dump completed on 2024-10-14  1:17:25
